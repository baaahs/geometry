        ...
        describe("edge calculation", function () {
            ...
            it("calculates length edge", function () {
                ...
                expect(edges.map(function (edge) {
                    return (edge.otherPanel ? edge.otherPanel.name : "?") + " @ " + MeasurementUtils.toPrettyFeetAndInches(edge.length());
            ...
            it("calculates panel outer edges for 6D", function () {
                ...
                expect(edgeAngles(edges)).toEqual(['5D @ 303°', '7D @ 168°', '12D @ 95°']);
            });
            ...
            it("calculates panel outer edges for 7D", function () {
                ...
                expect(edgeAngles(edges)).toEqual(['2D @ 274°', '8D @ 165°', '13D @ 44°', '6D @ 348°']);
            });
            ...
            it("calculates panel outer edges for 15D", function () {
                ...
                expect(edgeAngles(edges)).toEqual(['16D @ 232°', '20D @ 102°', '? @ 56°', '11D @ 325°']);
            });
